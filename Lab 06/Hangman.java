...
public class Hangman implements KeyListener
{
    ...
    private String pickSecretWord(String[] wordList, int wordListSize)
    {
        ...
        int randomInt = random.nextInt(wordListSize);
    ...
    private String constructInitialDisplayWord(String secretWord)
    {
        ...
        char unknown = UNKNOWN_CHARACTER;
        String finalStr = "";
        for(int i = 0; i < length; i++){
            finalStr = finalStr + unknown;
        }
        return finalStr;
    }
    ...
    private String updateDisplayWord(String displayWord, String secretWord, char guess)
    {
        ...
        char[] dword = displayWord.toCharArray();
        for(i = 0; i < length; i++){
            if(word[i] == guess){
                display = display + guess; 
            } else {
                display = display + dword[i];
            }
        }
        return display;
    }
